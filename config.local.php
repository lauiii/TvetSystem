...
if (!defined('SMTP_USER')) define('SMTP_USER', 'ascbtvet@gmail.com');
if (!defined('SMTP_PASS')) define('SMTP_PASS', 'tftjvkvecaquiyqk'); // replace with your Gmail App Password
if (!defined('SMTP_FROM')) define('SMTP_FROM', 'ascbtvet@gmail.com');
